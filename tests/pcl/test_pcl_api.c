...
TEST_SUITE_BEGIN(test_pcl_query_suite, "test_pcl_api", "PCL")
...
TEST_SUITE_BEGIN(test_pcl_hw_suite, "test_pcl_api", "PCL")
...
TEST_SUITE_BEGIN(test_pcl_validate_suite, "test_pcl_api", "PCL")
