...
static void print_usage(const str_t *prog_name)
{
    ...
    OSAL_Printf("  -a, --all               Run all PCL tests\n");
    OSAL_Printf("  -l, --list              List all PCL tests\n");
    ...
    OSAL_Printf("  %s -m test_pcl_api      # Run PCL API module tests\n", prog_name);
    OSAL_Printf("  %s -s test_pcl_init_suite  # Run specific suite\n", prog_name);
    OSAL_Printf("\n");
}
