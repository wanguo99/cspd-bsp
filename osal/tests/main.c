...
static void print_usage(const str_t *prog_name)
{
    ...
    OSAL_Printf("  -a, --all               Run all OSAL tests\n");
    OSAL_Printf("  -l, --list              List all OSAL tests\n");
    ...
    OSAL_Printf("  %s -m test_task         # Run task module tests\n", prog_name);
    OSAL_Printf("  %s -s test_task_suite   # Run specific suite\n", prog_name);
    OSAL_Printf("\n");
}
...
int32_t main(int32_t argc, str_t *argv[])
{
    ...
    OSAL_Printf("\n");
    OSAL_Printf("========================================\n");
    OSAL_Printf("  OSAL Module Unit Test\n");
