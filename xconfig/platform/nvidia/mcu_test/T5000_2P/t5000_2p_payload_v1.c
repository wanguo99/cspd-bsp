...
const xconfig_board_config_t xconfig_t5000_2p_v1 = {
    .platform = "nvidia/mcu_test",
    .product = "T5000_2P",
    .version = "v1.0",
    .description = "T5000-2P Payload Adapter Board V1.0 - with redundant MCU and IMU sensors",
